...
export default function Navigation() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-nina-cream/80 backdrop-blur-md border-b border-nina-beige/30">
      <nav className="mx-auto max-w-7xl px-5 lg:px-10 h-16 flex items-center justify-between">
      ...
      {open && (
        <div className="lg:hidden border-t border-nina-beige/30 bg-nina-cream">
