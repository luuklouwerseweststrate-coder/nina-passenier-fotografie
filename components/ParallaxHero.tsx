...
export default function ParallaxHero({ src, alt, children }: Props) {
  ...
  return (
    <section ref={ref} className="relative [min-height:100svh] lg:min-h-[90vh] flex items-center lg:items-end overflow-hidden">
      ...
      <div className="absolute -top-20 -right-40 w-[55vw] h-[55vw] rounded-full blur-3xl bg-commerce/15 pointer-events-none" />
      <div className="absolute -bottom-40 -left-40 w-[45vw] h-[45vw] rounded-full blur-3xl bg-free/12 pointer-events-none" />
